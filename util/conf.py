...
# etfs = [
#     'XLV', 'XLU', 'XLRE', 'XLP', 'XLK', 'XLI', 'XLF', 'XLB', 'VUG', 'VPL', 'VGK', 'SPY', 'SLV',
#     'QQQ', 'KWEB', 'ILF', 'IJR', 'IJH', 'GLD', 'FXI', 'EWG', 'EWC', 'DIA', 'AAXJ', 'XLY'
#     ]
...
etfs = [
    ...
    'VOO', 'PGX', 'UNG', 'MCHI', 'USMV', 'EWY', 'SPLV', 'VCIT', 'EZU', 'EWU'
    ]
